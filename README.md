...
- **זיהוי הדדי בין משתמשי הסקריפט (Peer Detection):** זיהוי אוטומטי והצגת תג ⚡ Unified לצד משתמשים אחרים בפורום שהתקינו ומשתמשים בסקריפט (ניתן לכיבוי/הפעלה בהגדרות).
